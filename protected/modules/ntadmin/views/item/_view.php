...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('daily_quota')); ?>:</b>
	<?php echo CHtml::encode($data->daily_quota); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('weekly_quota')); ?>:</b>
	<?php echo CHtml::encode($data->weekly_quota); ?>
	<br />
